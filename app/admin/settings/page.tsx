                ...
                return (
                    <div className="space-y-6">
                        <SectionCard title="Search Engine Optimization" icon="ri-search-eye-line" description="Improve how your site appears in search results">
                            <FieldGroup label="Site Title" description="The default <title> tag when no page-specific title exists"><input type="text" value={val('seo_title')} onChange={e => set('seo_title', e.target.value)} className={inputClass} placeholder="Adjetman Sneakers – Authentic Sneakers & Streetwear" /></FieldGroup>
